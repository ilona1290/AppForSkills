        ...
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Achievement>().HasData(
                new Achievement() { Id = 1, StatusId = 1, Category = "Skills", Amount = 1, Name = "Początkujący Skiller", 
                    Description = "Dodano pierwszy SkillPost", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg" },
                new Achievement() { Id = 2, StatusId = 1, Category = "Skills", Amount = 5, Name = "Szał umiejętności",
                    Description = "Dodano 5 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 3, StatusId = 1, Category = "Skills", Amount = 10, Name = "SkillMaster",
                    Description = "Dodano 10 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 4, StatusId = 1, Category = "Skills", Amount = 15, Name = "Co za utalentowana bestia",
                    Description = "Dodano 15 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 5, StatusId = 1, Category = "Skills", Amount = 25, Name = "SkillGod",
                    Description = "Dodano 25 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                ...
                new Achievement() { Id = 10, StatusId = 1, Category = "Komentarze", Amount = 125, Name = "Mógłby/Mogłaby napisać książkę, ale pisze komentarze",
                    Description = "Dodano 125 Komentarzy", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 11, StatusId = 1, Category = "Oceny", Amount = 1, Name = "Dam Ci gwiazdkę z nieba",
                    Description = "Oceniono pierwszy SkillPost", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 12, StatusId = 1, Category = "Oceny", Amount = 5, Name = "Taniec z gwiazdami",
                    Description = "Oceniono 5 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 13, StatusId = 1, Category = "Oceny", Amount = 15, Name = "Mówcie mi StarLord",
                    Description = "Oceniono 15 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 14, StatusId = 1, Category = "Oceny", Amount = 25, Name = "Mamo, możemy mieć własną konstelacje w domu?",
                    Description = "Oceniono 25 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 15, StatusId = 1, Category = "Oceny", Amount = 50, Name = "Dał/Dała tyle gwiazdek, że może nakręcić własny teledysk Shooting Stars",
                    Description = "Oceniono 50 SkillPost'ów", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 16, StatusId = 1, Category = "Dyskusje", Amount = 1, Name = "Chcę coś oznajmić",
                    Description = "Dołączono do pierwszej dyskusji", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 17, StatusId = 1, Category = "Dyskusje", Amount = 5, Name = "Zawsze musi być jakieś ALE",
                    Description = "Dołączono do 5 dyskusji", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 18, StatusId = 1, Category = "Dyskusje", Amount = 25, Name = "Naczelny Gaduła",
                    Description = "Dołączono do 25 dyskusji", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 19, StatusId = 1, Category = "Dyskusje", Amount = 50, Name = "Dyskutant-Alfa",
                    Description = "Dołączono do 50 dyskusji", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 20, StatusId = 1, Category = "Dyskusje", Amount = 100, Name = "Crushin' discussion",
                    Description = "Dołączono do 100 dyskusji", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 21, StatusId = 1, Category = "Posty w dyskusjach", Amount = 5, Name = "Ja tu tylko dyskutuję",
                    Description = "Udzielono się 5 razy w dyskusjach", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 22, StatusId = 1, Category = "Posty w dyskusjach", Amount = 15, Name = "Mam coś więcej do powiedzenia niż tylko ALE",
                    Description = "Udzielono się 15 razy w dyskusjach", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 23, StatusId = 1, Category = "Posty w dyskusjach", Amount = 25, Name = "Prowadzący Talk-Show",
                    Description = "Udzielono się 25 razy w dyskusjach", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 24, StatusId = 1, Category = "Posty w dyskusjach", Amount = 50, Name = "Nie zwrócimy Ci czasu jaki spędziłeś na pisaniu tych postów",
                    Description = "Udzielono się 50 razy w dyskusjach", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"},
                new Achievement() { Id = 25, StatusId = 1, Category = "Posty w dyskusjach", Amount = 200, Name = "200 postów już gotowych, milion kolejnych w drodze...",
                    Description = "Udzielono się 200 razy w dyskusjach", Logo = "https://appforskills1.blob.core.windows.net/achivement-logos/logo1.jpg"}
                );
