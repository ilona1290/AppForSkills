...
namespace AppForSkills.Persistance.Migrations
{
    ...
    [Migration("20210803112249_Add_one_to_many_relation_in_Comment_table")]
    partial class Add_one_to_many_relation_in_Comment_table
    {
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 499, DateTimeKind.Local).AddTicks(1384),
                            CreatedBy = "Turysta12",
                            SkillPostId = 2,
                            StatusId = 1,
                            UserId = 3
                        ...
                        new
                        {
                            Id = 2,
                            CommentText = "Dzięki.",
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 499, DateTimeKind.Local).AddTicks(2239),
                            CreatedBy = "Podrożnik",
                            ParentCommentId = 1,
                            SkillPostId = 2,
                            StatusId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Discussion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 499, DateTimeKind.Local).AddTicks(8815),
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 499, DateTimeKind.Local).AddTicks(9203),
                            CreatedBy = "Podróżnik",
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.PostInDiscussion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 500, DateTimeKind.Local).AddTicks(523),
                            CreatedBy = "Turysta12",
                            DiscussionId = 2,
                            PostText = "Australia",
                            Reported = false,
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 500, DateTimeKind.Local).AddTicks(536),
                            CreatedBy = "Podróżnik",
                            DiscussionId = 2,
                            ParentPostId = 1,
                            PostText = "Dlaczego?",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 500, DateTimeKind.Local).AddTicks(886),
                            CreatedBy = "Turysta12",
                            DiscussionId = 2,
                            ParentPostId = 2,
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 500, DateTimeKind.Local).AddTicks(896),
                            CreatedBy = "Podróżnik",
                            DiscussionId = 1,
                            PostText = "Jasne.",
                            Reported = false,
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 500, DateTimeKind.Local).AddTicks(899),
                            CreatedBy = "SuperAdmin",
                            DiscussionId = 2,
                            PostText = "Włochy",
                            Reported = false,
                        ...
                        {
                            Id = 6,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 500, DateTimeKind.Local).AddTicks(901),
                            CreatedBy = "SuperAdmin",
                            DiscussionId = 2,
                            ParentPostId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Rating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 499, DateTimeKind.Local).AddTicks(3347),
                            CreatedBy = "Turysta12",
                            SkillPostId = 2,
                            StatusId = 1,
                            UserId = 3,
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 499, DateTimeKind.Local).AddTicks(4312),
                            CreatedBy = "SuperAdmin",
                            SkillPostId = 2,
                            StatusId = 1,
                            UserId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.SkillPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 488, DateTimeKind.Local).AddTicks(1518),
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2021, 8, 3, 13, 22, 48, 497, DateTimeKind.Local).AddTicks(630),
                            CreatedBy = "Podróżnik",
