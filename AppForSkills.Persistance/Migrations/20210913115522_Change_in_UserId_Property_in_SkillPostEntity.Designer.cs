...
namespace AppForSkills.Persistance.Migrations
{
    ...
    [Migration("20210913115522_Change_in_UserId_Property_in_SkillPostEntity")]
    partial class Change_in_UserId_Property_in_SkillPostEntity
    {
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 14, DateTimeKind.Local).AddTicks(2978),
                            CreatedBy = "Turysta12",
                            SkillPostId = 2,
                            StatusId = 1,
                            UserId = 3
                        ...
                        new
                        {
                            Id = 2,
                            CommentText = "Dzięki.",
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 14, DateTimeKind.Local).AddTicks(4364),
                            CreatedBy = "Podrożnik",
                            ParentCommentId = 1,
                            SkillPostId = 2,
                            StatusId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Discussion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(3258),
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(3912),
                            CreatedBy = "Podróżnik",
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.PostInDiscussion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(5591),
                            CreatedBy = "Turysta12",
                            DiscussionId = 2,
                            PostText = "Australia",
                            Reported = false,
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(5612),
                            CreatedBy = "Podróżnik",
                            DiscussionId = 2,
                            ParentPostId = 1,
                            PostText = "Dlaczego?",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(5979),
                            CreatedBy = "Turysta12",
                            DiscussionId = 2,
                            ParentPostId = 2,
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(6098),
                            CreatedBy = "Podróżnik",
                            DiscussionId = 1,
                            PostText = "Jasne.",
                            Reported = false,
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(6106),
                            CreatedBy = "SuperAdmin",
                            DiscussionId = 2,
                            PostText = "Włochy",
                            Reported = false,
                        ...
                        {
                            Id = 6,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 15, DateTimeKind.Local).AddTicks(6111),
                            CreatedBy = "SuperAdmin",
                            DiscussionId = 2,
                            ParentPostId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Rating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 14, DateTimeKind.Local).AddTicks(6132),
                            CreatedBy = "Turysta12",
                            SkillPostId = 2,
                            StatusId = 1,
                            UserId = 3,
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 14, DateTimeKind.Local).AddTicks(7189),
                            CreatedBy = "SuperAdmin",
                            SkillPostId = 2,
                            StatusId = 1,
                            UserId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.SkillPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 9, 13, 13, 55, 20, 997, DateTimeKind.Local).AddTicks(8865),
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2021, 9, 13, 13, 55, 21, 12, DateTimeKind.Local).AddTicks(4422),
                            CreatedBy = "Podróżnik",
