...
namespace AppForSkills.Persistance.Migrations
{
    ...
    [Migration("20210728173033_added_data_to_AchievementUser_table")]
    partial class added_data_to_AchievementUser_table
    {
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 260, DateTimeKind.Local).AddTicks(1926),
                            CreatedBy = "Turysta12",
                            SkillPostId = 2,
                            StatusId = 0,
                            UserId = 3
                        ...
                        new
                        {
                            Id = 2,
                            CommentText = "Dzięki.",
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 260, DateTimeKind.Local).AddTicks(2621),
                            CreatedBy = "Podrożnik",
                            ParentCommentId = 1,
                            SkillPostId = 2,
                            StatusId = 0,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Discussion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 260, DateTimeKind.Local).AddTicks(8820),
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 260, DateTimeKind.Local).AddTicks(9177),
                            CreatedBy = "Podróżnik",
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.PostInDiscussion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 261, DateTimeKind.Local).AddTicks(407),
                            CreatedBy = "Turysta12",
                            DiscussionId = 2,
                            PostText = "Australia",
                            Reported = false,
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 261, DateTimeKind.Local).AddTicks(421),
                            CreatedBy = "Podróżnik",
                            DiscussionId = 2,
                            ParentPostId = 1,
                            PostText = "Dlaczego?",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 261, DateTimeKind.Local).AddTicks(762),
                            CreatedBy = "Turysta12",
                            DiscussionId = 2,
                            ParentPostId = 2,
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 261, DateTimeKind.Local).AddTicks(772),
                            CreatedBy = "Podróżnik",
                            DiscussionId = 1,
                            PostText = "Jasne.",
                            Reported = false,
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 261, DateTimeKind.Local).AddTicks(775),
                            CreatedBy = "SuperAdmin",
                            DiscussionId = 2,
                            PostText = "Włochy",
                            Reported = false,
                        ...
                        {
                            Id = 6,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 261, DateTimeKind.Local).AddTicks(777),
                            CreatedBy = "SuperAdmin",
                            DiscussionId = 2,
                            ParentPostId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.Rating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 260, DateTimeKind.Local).AddTicks(3636),
                            CreatedBy = "Turysta12",
                            SkillPostId = 2,
                            StatusId = 0,
                            UserId = 3,
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 260, DateTimeKind.Local).AddTicks(4548),
                            CreatedBy = "SuperAdmin",
                            SkillPostId = 2,
                            StatusId = 0,
                            UserId = 1,
            ...
            modelBuilder.Entity("AppForSkills.Domain.Entities.SkillPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 252, DateTimeKind.Local).AddTicks(6028),
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2021, 7, 28, 19, 30, 32, 259, DateTimeKind.Local).AddTicks(79),
                            CreatedBy = "Podróżnik",
